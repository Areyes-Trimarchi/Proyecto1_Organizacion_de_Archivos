exe:		main.o factura.o crud_LineasXClienteArbol.o crud_clientesarbol.o crud_CiudadesArbol.o b-tree.o b-treenode.o crud_LineasXCliente.o crud_Ciudades.o crud_clientes.o index.o 
		g++ main.o factura.o crud_LineasXClienteArbol.o crud_clientesarbol.o crud_CiudadesArbol.o b-tree.o b-treenode.o crud_LineasXCliente.o crud_Ciudades.o crud_clientes.o  index.o  -o exe
main.o:	main.cpp index.h factura.h crud_LineasXCliente.h crud_Ciudades.h crud_clientes.h crud_clientesarbol.h b-tree.h crud_CiudadesArbol.h crud_LineasXClienteArbol.h
		g++ -c main.cpp
factura.o:	factura.cpp factura.h b-tree.h
		g++ -c factura.cpp
